...
public class OverviewPaneControl {
    @FXML
    ...
    public void setOverviewPane(Predicate<Contracts> condition) {
        ...
        profitForPeriod.setText("Už periodą pelnas: " + ContractData.getInstance().realPaymentsForPeriod(searchStart.getValue(), searchEnd.getValue(), condition));
    }
